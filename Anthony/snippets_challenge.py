...
# both outputs must be false or there must be an 'and' operator

d = (5 < 7) or not (8 < 20)
print(d)
# TO DO: Explain how d is set to False in a print statement
# D is set to false in the print statement by changing one boolean operator and printing the varible. D evaluated if 2 math equations were True or Not (True or false).
# We changed the boolean sign to make one true and one false. 

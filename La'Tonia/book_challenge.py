...
# import pretty print to see sorted books by title clearer 
...
print('PART 1\n')
print(f'CODE CODED: my_library = Booklist() with print statements for my_library.books, and types of my_library and my_library.books')
my_library = Booklist()
...
'''
print('\nPart 2\n')
print(f'CODE CODED: my_library.books with series of add() to add books')
...
'''
print('\nPart 3\n')
print(f'CODE CODED: my_library.count_books() in a print statement')
...
-the method should take the self parameter, plus an additional parameter 'title' (a string for the title of the book to remove)
...
print('\nPart 4\n')
print(f'CODE CODED: my_library.remove_title() passing as argument title Just Mercy as a string')
# works but haven't been able to use the title string to remove instead of the index - that's the goal, correct? ... answer to self - yes, that's the goal and replaced lines 23-28 in book_class.py with lines 21-22
...
print('\nPart 5\n')
print(f'CODE CODED: nyt_bestsellers = Booklist() with series of add() to add and later sort books by title')
# my_library.nyt_bestsellers('THE WISH', 'Nicholas Sparks')
# my_library.nyt_bestsellers('NO CURE FOR BEING HUMAN', 'Kate Bowler')
nyt_bestsellers = Booklist()

# tinkered with titles/authors to test sort
nyt_bestsellers.add('ZEALOUS FOR THE HUM', 'Spate Crawler')
nyt_bestsellers.add('LINCOLN HIGHWAY', 'Amor Towles')
nyt_bestsellers.add('NO CURE FOR BEING HUMAN', 'Kate Bowler')
nyt_bestsellers.add('CLOUD CUCKOO LAND', 'Anthony Doerr')
nyt_bestsellers.add('GORGEOUS DAYS', 'Nate Brawler')
pprint(nyt_bestsellers.books)
print()
...
print('\nBONUS Part 6\n')
print(f'CODE CODED: display titles method on my_library and nyt_bestsellers')

my_library.display_titles()
nyt_bestsellers.display_titles()

# to witness pretty print in action
# doesn't look great but seems to work
pprint(my_library.display_titles())
pprint(nyt_bestsellers.display_titles())

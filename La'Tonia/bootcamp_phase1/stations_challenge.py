...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'{self.lines} stop at {self.station_name} and station is located at {self.location}.')     
...
st14_subway_station = SubwayStation(station_name='14th Street', location='14th street and 7th avenue', lines=['1', '2', '3', 'L'])
st14_subway_station.show_info()
print()
...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open:
           print(f'{self.station_name} located at {self.location} with routes: {self.routes}. Yes, it is {self.open} this station is currently open.')
        else:
            print(f'Station is Closed!') 
    
    def open_station(self):
        self.open = True
        print('Welcome Folks, The Station is Now Open!')

    def close_station(self):
        print('Apologies Folks, The Station is Closed!')
        self.open = False
        print()
...
'''
nyc_megabus_station = BusStation(station_name='NYC Megabus Stop', location='34th Street and 12th Avenue', routes=['Boston', 'DC', 'Philly'])
nyc_megabus_station.open_station()
nyc_megabus_station.close_station()
print()
nyc_megabus_station.show_info()
print()

...
if u * v == 10:
    # added another '=' so we are not assigning and making the value equal
...
# its set to False w/ the erasing of 'or' and replacing it w/  'and'
...
m = "GOAT"
n = "goat"
# changed the == to != to reflect the true statement.
o = (m != n)

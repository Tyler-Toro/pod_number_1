...
print('Question 5')
add_song(my_playlist, {"artist" : "Beastie Boys", "title" : "Sabotague"})
add_song(my_playlist, {"artist" : "Rage Against The Machine", "title" : "Bombtrack"})
add_song(my_playlist, {"artist" : "Soundgarden", "title" : "Good Eye Closed"})
add_song(my_playlist, {"artist" : "Faith No More", "title" : "From out of Nowhere"})
display_playlist(my_playlist)
print()

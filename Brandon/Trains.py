...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and makes stops at {self.lines}')
...
station1 = SubwayStation(station_name= '14th street', location = '14th street and 7th avenue', lines = ['1', '2', '3', 'L'])
station1.show_info()
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location} and makes stops at {self.routes}')
        if self.open == True:

...
# 1.3 TODO: We want to join the 
# first name and last name with a '.' and save it in a variable called 'joined_names'
...
for items in names:
    lower_names = items.lower()
    split_names = lower_names.split()
    join_name = '.'.join(split_names)
    email_list = join_name + '@ripplemedia.com'

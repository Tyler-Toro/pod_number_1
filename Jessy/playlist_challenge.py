...
add_song(my_playlist, {"artist":"Tupac","title":"To Live And Die In LA"})
...
print('Question 5')
add_song(my_playlist, {'artist':'Too Short', 'title':'The Ghetto'})
add_song(my_playlist, {'artist':'Thug Life', 'title':'Cradle to the Grave'})
display_playlist(my_playlist)

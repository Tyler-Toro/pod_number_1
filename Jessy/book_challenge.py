...
'''
print('PART 1\n')
# assigned my_library to Booklist()
my_library= Booklist()
# testing if it works
print(my_library)
# checking to see if it is a class type
...
'''
print('\nPart 2\n')
# using the .add method to insert title/author in my books list
my_library.add(title='Just Mercy', author='Bryan Stevenson')
# since it already has the parameters names, I do not need to type and assigned them
my_library.add('The New Jim Crow', 'Michelle Alexander')
my_library.add('The Truths We Hold', 'Kamala Harris')
my_library.add('My Grandmother\'s Hand', 'Resmaa Menakem')
...
'''
print('\nPart 3\n')
# I am figuring out that if all the method had is 'self', I dont have to put anything in the parathesis as an argument. I use the method as I would '.append'
...
nyt_bestsellers.add('Harlem Shuffle', 'Colson Whitehead')

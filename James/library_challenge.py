...
print(type(books_with_details[2]))
pprint(books)
...
def search_by_author(author):
    ...
    for author in books_with_details:
        if books_with_details[author]["author"] ==author:
            search_by_author.append(books_with_details[author]['title'])
...
search_by_author('Resnaa Menakem') 
print() 
'''
...
print(search_by_author('Timothy Syder')) 

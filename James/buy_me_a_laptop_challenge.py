...
print("asus_zenbook")
print("dell_xps")
print("lenovo_ideapad")
print("apple_macbook_air")
print("sony_viao")
...
print("the MacBook Pro url https://www.apple.com/macbook-pro-13/")

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
print("16-inch macbook pro prices $2399, $2799" )

# TODO: Write code to print all the color options for Dell XPS 13.
print("the Dell XPS 13 color options are Platinum silver exterior, black interior")

# TODO: Write code to print the description of Dell XPS laptop.
print("description" "The Dell XPS is an absolutely brilliant laptop. The 2020  version rocks an 11th-generation Intel Core i3, i5 or i7 processor and a bezel-less ‘Infinity Edge’ display. This Dell XPS continues to be the most popular Windows laptop in the world. What’s more, there’s a wide range of customization options, so you can really make the Dell XPS the best laptop for your needs. ")
...
laptops[0]["types"][0]["colors"].pop(1)
laptops[0]["types"][0]["storage"].pop(0)
...
print( "all the prices 1299, 1499, 1799, 2399, 2799, 999, 1099, 1149, 1249, 1199, 1299, 1399, 1749, 1999, 2299")

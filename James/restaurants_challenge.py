...
print(f"the address of four barrel coffee is {restaurant['address1']} which is found in {restaurant['city']} {restaurant['state']} ")
print(restaurant)
...
restaurant_1  = {
    "name": "Subway",
    "address" : "328 malcolm x blvd, NY 10027",
    "favourite_dish" : "fried cat fish" }
restaurant_2  = {
    "name": "Subway",
    "address" : "2153 frederick douglass blvd",
    "favourite_dish" : "bacon cheese burger" }
restaurant_3  = {
    "name": "Subway",
    "address" : "100 w 124th st",
    "favourite_dish" : "fried chicken wings" }
...
restaurant_1["address"]= '113 w 116th st'

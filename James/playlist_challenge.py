...
add_song(my_playlist,{'artist': 'mary j blige', 'title': 'my life'})
...
print('Question 5')
add_song(my_playlist,{'artist': 'jay z', 'title': 'celebration'})
add_song(my_playlist,{'artist': 'freeway', 'title': 'what we do'})
display_playlist(my_playlist)
...
print(np.average(monthly_plays))
